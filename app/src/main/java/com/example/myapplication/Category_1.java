/**
 * This class models the first plastic category's xml file content and buttons
...
public class Category_1 extends AppCompatActivity {
     ...
     * @param v represents the Category 1 xml file content
     */
    ...
    /**
     * On click method to take user to the recycling main category page
     * @param v represents the Category 1 xml file content
     */
