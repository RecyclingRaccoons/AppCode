/**
 * This class models the third plastic category page's xml file content and buttons
 * @author Recyling Raccoons
 */
...
public class Category_3 extends AppCompatActivity {
     ...
     * @param v represents the Category 3 xml file content
     */
    ...
    /**
     * On click method to take user to the main recycing categories page
     * @param v represents the Category 3 xml file content
     */
    ...
    /**
     * On click method to take user to the plastic page
     * @param v represents the Category 3 xml file content
     */
