/**
 * This class models the paper map sub-page's xml file content and buttons
...
public class PaperMap extends AppCompatActivity {
     ...
     * @param v represents the metal sub-page xml file content
     */
