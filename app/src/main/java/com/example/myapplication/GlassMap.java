/**
 * This class models the glass sub-page of the map
...
public class GlassMap extends AppCompatActivity {
     ...
     * @param v represents the glass sub page xml file content
     */
    ...
    /**
     * On click method to take user to the recycling main page
     * @param v represents the glass sub page xml file content
     */
