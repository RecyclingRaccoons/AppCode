/**
 * This class models the plastic map sub-page's xml file content and buttons
...
public class PlasticMap extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_plastic_map);
    }

    /**
     * On click method to take user to the main recycling page
     * @param v represents the plastic map sub-page page xml file content
     */
